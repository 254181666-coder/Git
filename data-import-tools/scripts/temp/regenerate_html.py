...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card h3 {
            font-size: 1em; color: #a0a0a0; margin-bottom: 15px;
...
# 用BOM头保存，强制UTF-8
with open('/Users/ann/Desktop/AI/Project/数据导入/april_comparison_fixed.html', 'w', encoding='utf-8-sig') as f:
    f.write(html_content)

print("新文件已生成：april_comparison_fixed.html")
print("文件使用UTF-8 BOM编码")
